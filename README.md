...
[![Build Status](https://img.shields.io/badge/build-in%20progress-orange)](https://github.com/asawarifuse/dignity-watch)

---

## 🎯 The Problem

Manual scavenging — cleaning sewers and septic tanks by hand — has been illegal in India since 2013. Yet hundreds of workers die every year. There is **no centralized, publicly accessible database** tracking these deaths. Government data is incomplete, delayed, and politically suppressed.

## 💡 The Solution

DIGNITY Watch automatically aggregates, verifies, and publishes structured data on manual scavenging incidents from 50+ multilingual sources.
